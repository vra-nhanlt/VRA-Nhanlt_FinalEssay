% This function has been downloaded from https://www.mathworks.com/help/vision/examples/image-retrieval-using-customized-bag-of-features.html
% I have not written it myself
function [features, metrics] = extractColorFeatures(I) 
[~,~,P] = size(I);
...
if isColorImage
    ...
    % Convert RGB images to the L*a*b* colorspace.
    Ilab = rgb2lab(I);                                                                             
